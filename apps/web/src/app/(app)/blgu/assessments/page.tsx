    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[var(--background)]">
        <div className="text-center bg-[var(--card)] backdrop-blur-sm rounded-sm p-8 shadow-lg border border-[var(--border)]">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-2">Error Loading Assessment</h3>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[var(--background)]">
        <div className="text-center bg-[var(--card)] backdrop-blur-sm rounded-sm p-8 shadow-lg border border-[var(--border)]">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-2">No Assessment Data Found</h3>
